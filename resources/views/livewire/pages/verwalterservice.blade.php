<div>
        ...
        <div class="section !py-0 text-white flex">
            ...
            <div class="w-full md:w-3/5 shadow-2xl text-white flex flex-col items-center px-6 md:px-12 py-24 relative">
                ...
                <h1 class="text-3xl md:text-5xl text-center mt-4 font-logo">
                    Zufriedene Kunden, die sich gut betreut fühlen, sind Ihr Kapital.
                </h1>
                ...
                <div class="flex flex-wrap w-full gap-2 items-center justify-center mt-4">
                    <p class="flex items-center gap-2">
                        ...
                        <a href="mailto:verwalterservice@bereal-immobilien.at" class="text-sm">office@bereal-immobilien.at</a>
                    </p>
                    <div class="size-1 bg-logo-50 rounded"></div>
                    <p class="flex items-center gap-2">
                        <svg class="size-5" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <a href="tel:+4315353619" class="text-sm">+43 1 535 36 19</a>
                    </p>
                </div>
                ...
                <div class="absolute top-full left-0 w-full bg-logo-500 rounded-b-full py-4 px-4 md:px-12 shadow-2xl z-10">
                    <div class="border-t border-white flex justify-between p-4">
                        <div class="flex gap-2 items-center text-sm">
                            ...
                            <p class="!text-sm !font-light">Schnelle<br> Hilfe</p>
                        </div>
                        <div class="flex gap-2 items-center text-sm">
                            <svg class="size-8 shrink-0" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"></path>
                            </svg>
                            <p class="!text-sm !font-light">Umfangreiche<br> Dokumentation</p>
                        </div>
                        <div class="flex gap-2 items-center text-sm">
                            <svg class="size-8 shrink-0" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <p class="!text-sm !font-light">White-Label<br> Service</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-section class="mt-16 !py-16 md:!py-32">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div data-aos="fade-up">
                <x-headings :level="2">
                    <x-slot name="tag">service</x-slot>
                    Professionell für Ihre Hausverwaltung
                </x-headings>

                <p class="text-base xl:text-lg font-light mt-4" data-aos="fade" data-aos-delay="300">
                    Sie möchten sich auf Ihr Kerngeschäft konzentrieren und trotzdem erstklassigen Service bieten?
                    Wir unterstützen Hausverwaltungen mit maßgeschneiderten Dienstleistungen, die Ihre Kunden begeistern
                    und Ihren Arbeitsalltag entlasten.
                </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-8" data-aos="fade" data-aos-delay="500">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm">Objektbegehungen</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="size-5 text-logo-300 shrink-0" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path></svg>
                        <span class="text-sm">Schadensdokumentation</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="size-5 text-logo-300 shrink-0" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path></svg>
                        <span class="text-sm">Mieterbetreuung</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="size-5 text-logo-300 shrink-0" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path></svg>
                        <span class="text-sm">Kosteneffizient</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="size-5 text-logo-300 shrink-0" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path></svg>
                        <span class="text-sm">Versicherungsabwicklung</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="size-5 text-logo-300 shrink-0" fill="none" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"></path></svg>
                        <span class="text-sm">Nachhaltige Lösungen</span>
                    </div>
                </div>

                <div class="mt-8" data-aos="fade" data-aos-delay="700">
                    <x-button href="mailto:verwalterservice@bereal-immobilien.at">Jetzt Beratung anfordern</x-button>
                </div>
            </div>

            <div class="relative" data-aos="fade-up" data-aos-delay="200">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
                    <img src="{{ asset('hausverwalterservice-header-rechts.jpg') }}" alt="Professioneller Verwalterservice" class="w-full h-full object-cover"/>
                </div>
    ...
    <x-section class="bg-logo-500/5 dark:bg-logo-500/10 !py-16 md:!py-32">
        <div class="text-center max-w-2xl mx-auto mb-16">
            ...
            <p class="text-base xl:text-lg font-light mt-4" data-aos="fade" data-aos-delay="300">
                Von der Objektbegehung bis zur Sanierungsbegleitung – wir bieten Ihnen ein umfassendes
                Leistungspaket, das keine Wünsche offen lässt.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="0">
                ...
                <h3 class="text-lg font-bold mb-2">Objektbegehungen</h3>
                <p class="text-sm font-light">Regelmäßige Begehungen und Zustandsberichte Ihrer Liegenschaften. Wir dokumentieren den baulichen Zustand und identifizieren Handlungsbedarf frühzeitig.</p>
            </div>
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-lg font-bold mb-2">Schadensmeldungen</h3>
                <p class="text-sm font-light">Professionelle Erfassung und Abwicklung von Schadensfällen. Lückenlose Dokumentation mit Fotos und detaillierten Berichten für Ihre Unterlagen.</p>
            </div>
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3 class="text-lg font-bold mb-2">Mieterkommunikation</h3>
                <p class="text-sm font-light">Wir übernehmen die Kommunikation mit Ihren Mietern – von der Terminvereinbarung bis zur Beschwerdebearbeitung, stets freundlich und lösungsorientiert.</p>
            </div>
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="300">
                ...
                <h3 class="text-lg font-bold mb-2">Dokumentation & Reporting</h3>
                <p class="text-sm font-light">Umfangreiche Dokumentation aller Vorgänge mit regelmäßigen Reports. Transparente Berichterstattung, damit Sie stets den Überblick behalten.</p>
            </div>
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="400">
                ...
                <h3 class="text-lg font-bold mb-2">Versicherungsabwicklung</h3>
                <p class="text-sm font-light">Komplette Abwicklung von Versicherungsfällen – von der Schadensmeldung bis zur Regulierung. Wir koordinieren alle Beteiligten für Sie.</p>
            </div>
            ...
            <div class="bg-white dark:bg-logo-950 rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow" data-aos="fade-up" data-aos-delay="500">
                ...
                <h3 class="text-lg font-bold mb-2">Sanierungsbegleitung</h3>
                <p class="text-sm font-light">Professionelle Begleitung von Sanierungsprojekten – von der Planung bis zur Abnahme. Wir sorgen für reibungslose Abläufe und Qualitätskontrolle.</p>
            </div>

        </div>

        <div class="mt-12 text-center" data-aos="fade-up" data-aos-delay="600">
            <p class="text-sm font-light mb-4">Sie benötigen eine maßgeschneiderte Lösung?</p>
            <x-button href="mailto:verwalterservice@bereal-immobilien.at">Kontaktieren Sie uns</x-button>
        </div>
    </x-section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            <div data-aos="fade-up">
                <x-headings :level="2" :ondark="true">
                    <x-slot name="tag">vertrauen</x-slot>
                    Schnell, Zuverlässig und mit Zufriedenheitsgarantie
                </x-headings>
                <p class="text-base xl:text-lg font-light text-white/80 mt-4" data-aos="fade" data-aos-delay="300">
                    Egal ob es sich um eine routinemäßige Objektbegehung oder einen dringenden Schadensfall handelt –
                    unser Team steht bereit, um schnell und professionell zu handeln. Ihre Zufriedenheit und die Ihrer
                    Kunden stehen für uns an erster Stelle.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 text-white">
                <div data-aos="fade-up" data-aos-delay="0">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">Zufriedenheitsgarantie</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Wir arbeiten so lange, bis Sie und Ihre Kunden zufrieden sind. Qualität ist unser Versprechen.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">Kostenlose Erstberatung</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Unverbindliche Erstberatung, um Ihre Anforderungen zu verstehen und die passende Lösung zu finden.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">Lokale Experten</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Unser Team kennt den Wiener Immobilienmarkt und die lokalen Gegebenheiten aus erster Hand.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">Schnelle Reaktionszeiten</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Dringende Anliegen werden priorisiert. Bei Notfällen sind wir kurzfristig vor Ort verfügbar.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="400">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">Flexible Termine</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Terminvereinbarungen, die sich an Ihrem Zeitplan orientieren – auch abends und am Wochenende möglich.</p>
                </div>
                ...
                <div data-aos="fade-up" data-aos-delay="500">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <h4 class="font-bold">100% Transparent</h4>
                    </div>
                    <p class="text-sm font-light text-white/70">Keine versteckten Kosten. Sie erhalten detaillierte Aufstellungen aller durchgeführten Arbeiten.</p>
                </div>
            </div>
        </div>
    </x-section>
    ...
    <x-section class="!py-16 md:!py-32">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
            <div class="relative order-last md:order-first" data-aos="fade-up">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
                    <img src="{{ asset('hausverwalterservice-header-links.jpg') }}" alt="So funktioniert der Verwalterservice" class="w-full h-full object-cover"/>
                </div>
                <div class="absolute -bottom-6 -right-6 bg-logo-500 text-white rounded-2xl p-6 shadow-lg hidden md:block" data-aos="fade-up" data-aos-delay="400">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-sm font-bold">Über 500+</p>
                            <p class="text-xs text-white/70">betreute Objekte</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <x-headings :level="2">
                    <x-slot name="tag">ablauf</x-slot>
                    So funktioniert unser Verwalterservice
                </x-headings>
                ...
                <div class="mt-8 space-y-8">
                    <div class="flex gap-5">
                        ...
                        <div>
                            <h4 class="font-bold text-lg">Kontaktaufnahme</h4>
                            <p class="text-sm font-light mt-1">Sie kontaktieren uns per Telefon oder E-Mail und schildern Ihren Bedarf. Wir nehmen uns Zeit für Ihre Anliegen und beraten Sie umfassend.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-5">
                        ...
                        <div>
                            <h4 class="font-bold text-lg">Bedarfsanalyse & Angebot</h4>
                            <p class="text-sm font-light mt-1">Nach der Kontaktaufnahme analysieren unsere Experten Ihren individuellen Bedarf und erstellen ein maßgeschneidertes Angebot für Sie.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-5">
                        ...
                        <div>
                            <h4 class="font-bold text-lg">Professionelle Umsetzung</h4>
                            <p class="text-sm font-light mt-1">Unser geschultes Team setzt alle vereinbarten Leistungen zuverlässig um. Sie erhalten lückenlose Dokumentation und regelmäßige Updates.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 md:py-32 bg-logo-500/5 dark:bg-logo-500/10">
        <div class="lg:max-w-4xl xl:max-w-6xl mx-auto px-4 text-center">
            <div data-aos="fade-up">
                <x-headings :level="2">
                    <x-slot name="tag">kontakt</x-slot>
                ...
                <p class="text-base xl:text-lg font-light mt-4 max-w-2xl mx-auto" data-aos="fade" data-aos-delay="300">
                    Überzeugen Sie sich selbst von unserem Verwalterservice. Kontaktieren Sie uns für eine
                    unverbindliche Erstberatung und erfahren Sie, wie wir Ihre Hausverwaltung unterstützen können.
                </p>
            </div>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8" data-aos="fade-up" data-aos-delay="500">
                <x-button href="mailto:verwalterservice@bereal-immobilien.at">Jetzt Kontakt aufnehmen</x-button>
                <a href="tel:+4315353619" class="flex items-center gap-2 text-logo-500 dark:text-logo-300 font-medium hover:underline">
