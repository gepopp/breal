...
<div x-data="{ open: false }" class="relative">
    <header class="p-4 flex justify-between bg-white dark:bg-logo-950 dark:text-white">
        ...
        <div class="hidden sm:flex flex-1 max-w-1/2 md:max-w-sm ml-16 md:ml-0 items-end md:items-center md:mt-1 relative">
        ...
        <div class="hidden md:flex flex-col items-center justify-end min-h-full mb-1">
            <x-button>kontakt</x-button>
        </div>

        <div class="flex items-center sm:hidden" x-data="{ show:false }">
            ...
            <svg x-on:click="open = !open" class="size-6 text-logo dark:text-white"
                ...
                <line :class="open ? 'rotate-45 origin-center scale-x-110' : ''"
                      class="transition-all duration-300 ease-in-out" x2="25" transform="translate(1.5 7.5)" fill="none"
    ...
    <div class="hidden sm:flex w-full p-4 bg-logo-500 text-white justify-center items-center space-x-4">
    ...
    <div x-cloak x-show="open" x-collapse class="absolute top-full left-0 w-full p-4 bg-logo-500 text-white flex justify-center items-center space-x-4">
        <a href="#">leistungen</a>
        <a href="#">service</a>
        <a href="#">karriere</a>
    </div>
