<div @class([
    ...
    <div @class(['order-first md:order-last -mx-4 md:ml-0 mb-8 relative overflow-hidden'])>
        <img src="{{ $media->getUrl() }}" srcset="{{ $media->getSrcset() }}" alt="{{ $alt }}" data-aos="fade" data-aos-delay="600" class="h-full w-auto object-cover"/>

        <div class="absolute top-0 left-0 w-[20%] h-full hidden md:block">
            <svg @class(['text-white h-full w-auto']) fill="currentColor" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 85.3 501">
