...
<head>
    ...
    <style type="text/css" class="export-delete">
        ...
        .composer--mobile .m-height20 {
            font-sPoppinsize: 20px !important;
            line-height: 20px !important;
            height: 20px !important;
        }
...
<div data-primary-font="Poppins Slab" data-secondary-font="Poppins"
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
        <td align="center" data-bgcolor="Body" bgcolor="#ffffff" class="container-padding" data-composer>

            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row"
                   role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-logo">
                <!-- black-logo -->
                <tr>
                ...
                <tr data-element="black-logo" data-label="Logo">
                    <td align="center">
                        <img style="width:189px;border:0px;display: inline!important;"
                             src="{{ asset('logo-newsletter-189.jpg') }}" width="189"
                             border="0" editable="true" data-icon data-image-edit data-url data-label="Logo"
            ...
            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row"
                   role="presentation" width="580" style="width:580px;max-width:580px;" data-module="black-intro-2">
                <!-- black-intro-2 -->
                <tr>
            ...
            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row"
                ...
                <tr data-element="black-intro-2-paragraph" data-label="Intro Paragraph">
                    <td data-text-style="Intro Paragraph" align="center"
                        style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#1b1b18;text-decoration:none;letter-spacing:0px;">
                        Sie können diese Anfrage, über klickt auf untenstehenden Button als "gelöst" markieren, dann erscheint sie im Backend der Webseite nicht mehr bei den offenen Anfragen.
                    </td>
                </tr>
                <tr data-element="black-intro-2-paragraph" data-label="Intro Paragraph">
                    <td height="40" style="font-size:40px;line-height:40px;"
                                ...
                                <td align="center" data-border-radius-default="0,6,36"
                                    ...
                                    <![endif]-->
                                        <a href="{{ $link ?? '#' }}" mc:edit data-button data-text-style="Intro Button"
                                           style="font-family:'Poppins',Arial,Helvetica,sans-serif;text-transform:lowercase;font-size:18px;line-height:28px;font-weight:700;font-style:normal;color:#ffffff;text-decoration:none;letter-spacing:0px;padding: 16px 38px 16px 38px;display: inline-block;"><span>Anfrage als gelöst markieren</span></a>
                                    <!--[if (gte mso 9)|(IE)]>
                                    </td>
                                    <td align="center" width="38"></td>
                                    </tr>
                ...
                <tr>
                    <td align="center" height="8" data-border-color="dotted-dividers"
                        style="font-size:8px;line-height:8px;border-top: 8px dotted #333333;">&nbsp;
                    </td>
                </tr>
                <tr>
                    <td height="30" style="font-size:30px;line-height:30px;" data-height="Spacing bottom">&nbsp;</td>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580"
                   style="width:580px;max-width:580px;" data-module="black-footer">
                <!-- black-footer -->
                <tr>
                    <td height="30" style="font-size:30px;line-height:30px;" data-height="Footer spacing top">&nbsp;
                    </td>
                </tr>
                    ...
                    <td align="center">
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                            <tr class="center-on-mobile">
                                <td data-element="black-footer-1st-link" data-label="1st Link"
                                    data-text-style="Footer Links" class="rwd-on-mobile center-text" align="center"
                                ...
                                <td data-element="black-footer-gap-1" data-label="1st Gap" class="hide-mobile"
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <td class="center-text" data-text-style="Paragraphs" align="center"
                                                style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:28px;line-height:28px;font-weight:100;font-style:normal;color:#444444;text-decoration:none;letter-spacing:0px;">|
                                            </td>
                                            <td width="10"></td>
                                        </tr>
                                    </table>
                                </td>
                                <td data-element="black-footer-2nd-link" data-label="2nd Link"
                                    data-text-style="Footer Links" class="rwd-on-mobile center-text" align="center"
                                    style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
                                    <!-- Links -->
                                    <singleline>
                                ...
                                <td data-element="black-footer-gap-2" data-label="2nd Gap" class="hide-mobile"
                                    align="center" valign="middle">
                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                           role="presentation">
                                        <tr>
                                ...
                                <td data-element="black-footer-3rd-link" data-label="3rd Link"
                                    data-text-style="Footer Links" class="rwd-on-mobile center-text" align="center"
                                    style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
                                    <!-- Links -->
                                    <singleline>
                ...
                <tr data-element="black-footer-paragraphs" data-label="Paragraphs">
                    <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing above tags">&nbsp;
                    </td>
                </tr>
                <!-- black-footer -->
            </table>
