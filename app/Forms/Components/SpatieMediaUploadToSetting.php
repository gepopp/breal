...
class SpatieMediaUploadToSetting extends FileUpload
{
    use HasMediaFilter;
    ...
    protected function setUp(): void
    {
        ...
        $this->loadStateFromRelationshipsUsing(static function (SpatieMediaUploadToSetting $component, HasMedia $record): void {
        ...
        $this->afterStateHydrated(static function (BaseFileUpload $component, string|array|null $state): void {
            ...
            if(is_numeric($state)) {
                $media = Media::whereId($state)->first();
                $component->state([$media->uuid => $media->getAttributeValue('uuid')]);
                return;
            }
        ...
        $this->getUploadedFileUsing(static function (SpatieMediaUploadToSetting $component, string $file): ?array {
        ...
        $this->saveRelationshipsUsing(static function (SpatieMediaUploadToSetting $component) {
            $component->deleteAbandonedFiles();
            $component->saveUploadedFiles();
        });

        $this->saveUploadedFileUsing(static function (SpatieMediaUploadToSetting $component, TemporaryUploadedFile $file, ?Model $record): ?string {
        ...
        $this->reorderUploadedFilesUsing(static function (SpatieMediaUploadToSetting $component, ?Model $record, array $state): array {
